$(function() {
    ...
    service.fnDataTable("#tableSubMenuCarrossel", "tableSubMenuCarrossel", columns, columnDefs);
    //service.advancedSearch("tableSubMenuCarrossel");
    service.datepicker();
    
    /** PESQUISA AVANÇADA*/
    $(document).ready(function() {    	
    	var table = $("#tableSubMenuCarrossel").DataTable();
